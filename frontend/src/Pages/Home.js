...
const Home = ({ city }) => {
    ...
    return (
        <div className='flex justify-around items-center flex-col sm:flex-row lg:flex-row md:flex-row w-[100%] h-[100%] mt-2 mb-4'>
            <div className='w-[74%] sm:w-[58%] lg:w-[58%] md:w-[58%] h-[38vw] min-h-[300px] sm:h-[100vh] md:h-[100vh] lg:h-[100vh] items-center flex justify-center'>
            <Map city={city} className ='w-[100%] h-[100%]' />
            </div>
            ...
            <div className='flex flex-col gap-20 w-[100%] sm:w-[40%] lg:w-[40%] md:w-[40%] justify-center items-center'>
                <div className='flex flex-col mt-8 gap-4 items-center'>
                    <h1 className='text-2xl sm:text-2xl md:text-2xl lg:text-2xl font-semibold font-bold'>Get your desired route </h1>
