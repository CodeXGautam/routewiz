...
const Home = ({ city }) => {
    ...
    return (
        <div className='relative flex justify-around flex-col sm:flex-row lg:flex-row md:flex-row items-center w-[100%] h-[100%] mt-2 mb-4'>
            <div className='w-[74%] sm:w-[58%] lg:w-[58%] md:w-[58%] h-[350px] absolute sm:h-[100vh] md:h-[100vh] lg:h-[100vh]   items-center flex justify-center'>
